  ...
  return (
      ...
      <div className="articleMainContainer">
        ...
        <div className="articleContainer">
         ...
         <span>{sample[0][localStorage.getItem("Index")] ? sample[0][localStorage.getItem("Index")].ArtNo : sample[0][0].ArtNo }</span>   
          </div>
          <div className = "articleRow">
            <span className = "colTitle">Name: </span>
            {sample[0][localStorage.getItem("Index")] ? sample[0][localStorage.getItem("Index")].Name : sample[0][0].Name}
          </div>
          {sample[0][localStorage.getItem("Index")].SubHeading ? (
            <div className = "articleRow">
              <span className = "colTitle">SubHeading: </span>
              {sample[0][localStorage.getItem("Index")] ? sample[0][localStorage.getItem("Index")].SubHeading : sample[0][0].SubHeading }
            </div>
          ) : (
            <></>
          )}
          {sample[0][localStorage.getItem("Index")].ArtDesc ? (
            <div className = "articleRow">
              <span className = "colTitle">Article Description: </span>
              {sample[0][localStorage.getItem("Index")] ? sample[0][localStorage.getItem("Index")].ArtDesc : sample[0][0].ArtDesc }
            </div>
          ) : (
            <></>
          )}
          {sample[0][localStorage.getItem("Index")].Status ? (
            <div className = "articleRow">
              ...
              {sample[0][localStorage.getItem("Index")] ? sample[0][localStorage.getItem("Index")].Status : sample[0][0].Status }
            </div>
          ) : (
            <></>
          )}
          {sample[0][localStorage.getItem("Index")].Clauses ? (
            <div className = "articleRow">
              ...
              {sample[0][localStorage.getItem("Index")].Clauses.map(
                (clause) => (
                  <div style ={{display : "flex"}}>
                    <div style = {{marginRight : "0.5rem"}}>{clause.ClauseNo}.</div>
...
{sample[0][localStorage.getItem("Index")].Explanations ? (
            <div>
              ...
              {sample[0][localStorage.getItem("Index")].Explanations.map(
                (clause) => (
                  <div style ={{display : "flex"}}>
                    <div style ={{marginRight : "0.5rem"}}>{clause.ExplanationNo}.</div>
